...
> 插件修改自[astrbot_plugin_parser](https://github.com/Zerhalslar/astrbot_plugin_parser)，非本插件独有的解析器若出现问题请使用原插件，可能已更新修复。
此插件新增解析器：磁力解析器、iwara解析器

## 📖 介绍

当前支持的平台和类型：

| 平台    | 触发的消息形态                    | 视频 | 图集 | 音频 | 详情信息 |
| ------- | -------------------------------  |:---:|:----:|:----:|:-------:|
