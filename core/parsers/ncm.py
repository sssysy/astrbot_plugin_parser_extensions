...
from data.plugins.astrbot_plugin_parser.core.data import AudioContent, ImageContent, Platform, SendGroup
    ...
    async def _generate_preview(
        ...
        try:
            ...
            if not font_path.exists():
                logger.debug(f"[NCM] _generate_preview - 基础插件字体文件不存在: {font_path}")
                font_path = None
